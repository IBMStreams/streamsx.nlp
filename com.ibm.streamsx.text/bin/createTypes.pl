...
composite $compositeName
{
	graph 
		...
		stream<rstring text, list<$annoType> annotations> TextAnnotated = com.ibm.streamsx.text::UimaText(TextStream as I) {
			param
...
sub main() {
    ...
    #print $dirname."\n";
    my $xsltScriptDir = $dirname."/../com.ibm.streamsx.text/Common/xslt";
